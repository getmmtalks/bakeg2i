...
class VeiculosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'veiculos_ibfk_1' => ['type' => 'foreign', 'columns' => ['marca_id'], 'references' => ['marcas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'marca_id' => 1,
                'ano' => 1,
                'created' => '2021-10-21 00:54:18',
                'updated' => '2021-10-21 00:54:18',
                'deleted' => '2021-10-21 00:54:18',
            ],
        ];
        parent::init();
    }
